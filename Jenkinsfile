  ...
  stages {
    ...
    stage('Test') {
      steps {
        ...
        bat 'python test1.py --builds 3 --parallel 3 --error_commands 3 --username lambdatestdemo --access_key 0H7V3MMGoZeafPIJTySEvJR5V4hKuWsJXtGOJ2cuT96YLt7jhu --env prod --test_name "Sample Flaky Test" --build_name "Sample Flaky Build 2"'
      }
    }
  }
  }
