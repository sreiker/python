    ...
    def run_demo_site_test(self, build_num, test_id, capabilities, command_count, error_commands, error_repeat):
        try:
            ...
            errorFunctions = [
                ...
                lambda: (driver.get('http://www.google.com'),driver.set_page_load_timeout(30), driver.get('http://www.google.com'), driver.get_cookie('abd'), driver.add_cookie({"name": "foo", "value": "bar"}), driver.get_cookie('foo') ),#NoSuchCookie
